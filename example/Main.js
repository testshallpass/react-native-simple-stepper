    ...
    return (
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={{flexDirection: 'column', alignItems: 'center'}}>
          ...
          <SimpleStepper valueChanged={this.valueChangedPeru} tintColor={'peru'} maximumValue={25} initialValue={.99} stepValue={.99}/>
          <Text style={styles.text}> {'\n'}{'min is 0, max is 25, initialValue is .99 and stepValue is .99'}{'\n'} </Text>
