...
export interface SimpleStepperProps {
  ...
  disabled?: boolean;
  renderDecrementImage(props: SimpleStepperProps): ReactNode;
  renderIncrementImage(props: SimpleStepperProps): ReactNode;
  renderDecrementStep(props: SimpleStepperProps): ReactNode;
  renderIncrementStep(props: SimpleStepperProps): ReactNode;
  wraps?: boolean;
